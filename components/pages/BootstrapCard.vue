<template>
  <div>
    ...
    <div class="section-body">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-6">
          ...
          <div class="card">
            ...
            <div class="card-body">This is some text within a card body.</div>
            <div class="card-footer bg-whitesmoke">Footer Card</div>
          </div>
        </div>
      </div>
      ...
      <p class="section-lead">You can provide functionality on the card.</p>
      ...
      <div class="row">
        <div class="col-12 col-sm-6 col-lg-6">
          <div class="card">
            ...
            <div class="collapse show" id="mycard-collapse">
              <div class="card-body">You can show or hide this card.</div>
        ...
        <div class="col-12 col-sm-6 col-lg-6">
          <div class="card" id="mycard-dimiss">
            ...
            <div class="card-body">You can dimiss this card.</div>
            <div class="card-footer">Card Footer</div>
          </div>
      ...
      <p class="section-lead">Other cool cards, this one can be sorted.</p>
